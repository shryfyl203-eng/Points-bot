...
TOKEN = MTUwOTE0NDU5MzM5OTE1Njc3OA.G8ykWp.k7hTgQpnvSX8kElC3hfLAD_-Ig7o__Q7EIL4_E
TARGET_BOT_ID = int(os.getenv("TARGET_BOT_ID", 725721249652670555))  # پیش‌فرض
POINTS_PER_MENTION = int(os.getenv("POINTS_PER_MENTION", 10))

if not TOKEN:
    print("❌ توکن پیدا نشد! متغیر DISCORD_TOKEN را چک کن.")
    exit(1)
...
async def on_ready():
    ...
    print(f'🎯 هدف: بات با آیدی {TARGET_BOT_ID}')
